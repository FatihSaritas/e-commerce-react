    ...
    <section className="contact">
      <div className="contact-top">
        <div className="contact-map">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d188.54381946322948!2d29.26459862449281!3d40.87843304062906!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cadb629d53f3f5%3A0x32261cd31d68a44a!2sU%C4%9Fur%20Elektronik!5e0!3m2!1str!2str!4v1721644967868!5m2!1str!2str"
            width="100%"
            height="500"
            allowFullscreen=""
            style={{ border: 0 }}
        ...
        <div className="container">
          ...
          <div className="contact-elements">
            <form className="contact-form">
              ...
              <button className="btn btn-sm form-button form-button">
                Send Message
              </button>
            </form>
