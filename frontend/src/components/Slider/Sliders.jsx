...
function Sliders() {
  ...
  const nextSlide = () => {
    setCurrentSlide((prevSlide) => (prevSlide + 1) % 3); // mod işlemi başa dönmeyi sağlıyor kalana alıyor
  };

  const prevSlide = () => {
    setCurrentSlide((prevSlide) => (prevSlide - 1 + 3) % 3); // mod işlemi başa dönmeyi sağlıyor kalana alıyor
  };
  ...
  return (
    <section className="slider">
      <div className="slider-elements">
        ...
        {/* burdaki imagesrc bir props oluyor props komponentler arasında veri aktarımı sağlar */}
